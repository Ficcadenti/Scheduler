...
INSERT INTO `batch_lib` VALUES (1,1,'batch30gg','BATCH a 30 giorni','batch30gg.php'),(2,2,'batch60gg','BATCH a 60 giorni','batch60gg.php'),(3,3,'batch2year','BATCH a 2 anni','batch2year.php'),(4,4,'batchClear','BATCH Clear BATCH','batchClear.php'),(5,5,'batchUser','BATCH a date variabili','batchUser.php'),(6,6,'batchClearFileImp','BATCH Clear file importati','batchClearFileImp.php');
...
CREATE TABLE `batch_type_lib` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_download_report_type` int(11) DEFAULT NULL,
  `descrizione` varchar(100) DEFAULT NULL,
  `suffisso_file_csv` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `batch_type_lib` VALUES (1,1,'AdGroup Metriche','ADGM'),(2,2,'AdGroup Anagrafiche','ADGA'),(3,3,'Campagne Metriche','CAMM'),(4,4,'Campagne Anagrafiche','CAMA'),(5,5,'Keywords Metriche','KEYA'),(6,6,'Keywords Anagrafiche','KEYM'),(7,7,'URL Metriche','URLM'),(8,8,'URL Anagrafiche','URLA'),(9,9,'ALL Metriche','ALLM'),(10,10,'ALL Anagrafiche','ALLA'),(11,11,'Undefined','UNDEF');
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='Tabella di configurazione scheduler';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sc_config` VALUES (35,'devadplify',20,4,'4','{\"id_schedulazione\":-1,\"hostname\":\"devadplify\",\"id_user\":20,\"id_account_adw\":2,\"id_batch\":4,\"descr_schedulazione\":\"BATCH a 30 giorni\",\"type_schedulazione\":7,\"frequenza\":-1,\"stato_schedulazione\":6,\"tipo_batch\":1,\"time_start\":\"2017-03-15 20:00:00\",\"dal\":\"20170212\",\"al\":\"20170311\"}',7,60,'2017-03-16 16:31:00','2017-03-16 16:30:00',6,NULL,'2017-03-15 21:04:00','0',''),(36,'devadplify',20,2,'2','{\"id_schedulazione\":-1,\"hostname\":\"devadplify\",\"id_user\":20,\"id_account_adw\":8374530883,\"id_batch\":1,\"descr_schedulazione\":\"BATCH a 30 giorni\",\"type_schedulazione\":7,\"frequenza\":-1,\"stato_schedulazione\":6,\"download_report_type\":9,\"time_start\":\"2017-03-16 09:40:00\",\"dal\":\"20170212\",\"al\":\"20170311\"}',7,3600,'2017-03-16 16:34:59','2017-03-16 16:29:00',6,NULL,'2017-03-16 09:30:15','0','[batch60gg_work] '),(37,'devadplify',20,6,'6','{\"id_schedulazione\":-1,\"hostname\":\"devadplify\",\"id_user\":20,\"id_account_adw\":2,\"id_batch\":6,\"descr_schedulazione\":\"BATCH a 30 giorni\",\"type_schedulazione\":7,\"frequenza\":-1,\"stato_schedulazione\":6,\"download_report_type\":11,\"time_start\":\"2017-03-16 16:30:00\",\"dal\":\"20170212\",\"al\":\"20170311\"}',7,-1,'2017-03-16 16:29:59','2017-03-16 16:30:00',6,NULL,'2017-03-16 16:29:01','0','');
...
-- Dump completed on 2017-03-17  8:22:22
