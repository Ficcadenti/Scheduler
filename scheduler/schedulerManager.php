...
class SchedulerManager {
	...
	public function setBatch($parameter) {
		if($this->connetion==true)
		{
			...
			{
				$this->log->info("Non � definito il parametro 'tag' !!!");
				return false;	
			}
			if (! isset ( $this->param->id_schedulazione )) 
			{
				$this->log->info("Non � definito il parametro 'id_schedulazione' !!!");
				return false;	
			}
			if (! isset ( $this->param->hostname ))
			{
				$this->log->info("Non � definito il parametro 'hostname' !!!");
				return false;
			}
			if (! isset ( $this->param->id_user ))
			{
				$this->log->info("Non � definito il parametro 'id_user' !!!");
				return false;
			}
			if (! isset ( $this->param->id_account_adw ))
			{
				$this->log->info("Non � definito il parametro 'id_account_adw' !!!");
				return false;
			}
			if (! isset ( $this->param->id_batch ))
			{
				$this->log->info("Non � definito il parametro 'id_batch' !!!");
				return false;
			}
			if (! isset ( $this->param->descr_schedulazione ))
			{
				$this->log->info("Non � definito il parametro 'descr_schedulazione' !!!");
				return false;
			}
			if (! isset ( $this->param->type_schedulazione ))
			{
				$this->log->info("Non � definito il parametro 'type_schedulazione' !!!");
				return false;
			}
			if (! isset ( $this->param->frequenza ))
			{
				$this->log->info("Non � definito il parametro 'frequenza' !!!");
				return false;
			}
			if (! isset ( $this->param->stato_schedulazione ))
			{
				$this->log->info("Non � definito il parametro 'stato_schedulazione' !!!");
				return false;
			}
			if (! isset ( $this->param->download_report_type ))
			{
				$this->log->info("Non � definito il parametro 'download_report_type' !!!");
				return false;
			}
			if (! isset ( $this->param->abilita_anagrafiche ))
			{
				$this->log->info("Non � definito il parametro 'abilita_anagrafiche' !!!");
				return false;
			}
			if (! isset ( $this->param->status_anagrafiche ))
			{
				$this->log->info("Non � definito il parametro 'status_anagrafiche' !!!");
				return false;
			}
			if (! isset ( $this->param->abilita_metriche ))
			{
				$this->log->info("Non � definito il parametro 'abilita_metriche' !!!");
				return false;
			}
			if (! isset ( $this->param->status_metriche ))
			{
				$this->log->info("Non � definito il parametro 'status_metriche' !!!");
				return false;
			}
			if (! isset ( $this->param->time_start ))
			{
				$this->log->info("Non � definito il parametro 'time_start' !!!");
				return false;
			}
			if (! isset ( $this->param->dal ))
			{
				$this->log->info("Non � definito il parametro 'dal' !!!");
				return false;
			}
			if (! isset ( $this->param->al ))
			{
				$this->log->info("Non � definito il parametro 'al' !!!");
				return false;
			}
		}
		else
